                                ...
                                {block name='account-my-account-shipping-address-no-data'}
                                    {cardbody class="d-flex justify-content-center align-items-center flex-column"}
                                        ...
                                        {link class="btn btn-outline-secondary btn-sm"
                                                aria=["label"=>{lang key='shippingAdress' section='account data'}]
                                                href="$cCanonicalURL?editLieferadresse=1"}
                                            <i class="fa fa-truck" title="{lang key='shippingAdress' section='account data'}"></i>
