                            ...
                            {col cols=12 md=6}
                                {block name='checkout-inc-billing-address-form-salutation'}
                                    ...
                                    {if isset($fehlendeAngaben.anrede)}
                                        <div class="form-error-msg" aria-live="assertive" role="alert" aria-atomic="true"><i class="fas fa-exclamation-triangle"></i>
                                            {lang key='fillOut'}
                                        </div>
                                    {/if}
                            ...
                            {col cols=12}
                                {formgroup
                                    ...
                                    {if isset($fehlendeAngaben.ustid)}
                                        <div class="form-error-msg" aria-live="assertive"><i class="fas fa-exclamation-triangle"></i>
