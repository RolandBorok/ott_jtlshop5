                    ...
                    <div class="form-icon">
                        {inputgroup}
                            ...
                            {inputgroupaddon append=true}
                                {button type="submit" variant="secondary" aria=["label"=>{lang key='search'}] title="{lang key='search'}"}<span class="fas fa-search" aria-hidden="true" role="img" aria-label="{lang key='search'}"></span>{/button}
                            {/inputgroupaddon}
