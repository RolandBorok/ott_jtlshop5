                            ...
                            <blockquote>
                                ...
                                <div class="blockquote-footer">
                                    ...
                                    {block name='productdetails-review-item-details-verified-purchase'}
                                        ...
                                        {/if}
                                    {/block}
                                    {block name='productdetails-review-item-details-has-credit-bonus'}
                                        {if !empty($oBewertung->hasCreditBonus)}
                                            <span class="blockquote-divider"></span>
                                            <span class="has-credit-bonus"
                                                data-toggle="tooltip"
                                                data-placement="auto"
                                                title="{lang key='hasCreditBonusDesc' section='product rating'}">
                                                {lang key='hasCreditBonus' section='product rating'}
                                            </span>
                                        {/if}
                                    {/block}
                                </div>
