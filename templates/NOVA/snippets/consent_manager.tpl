                                ...
                                {block name='snippets-consent-manager-banner-body-description-description'}
                                    <p>
                                        {lang key='consentDescription' section='consent'
                                            printf=$items|join:', '|cat:':::'|cat:$privacyUrl}
                                    </p>
                                    {if $imprintUrl !== '#'}
            ...
            <div id="consent-settings" class="consent-modal" role="dialog" aria-modal="true">
                <div class="consent-modal-content" role="document">
                    {block name='snippets-consent-manager-settings-close'}
                        <button type="button" class="consent-modal-close" data-toggle="consent-close" title="{lang key='close' section='consent'}">
                                ...
                                {block name='snippets-consent-manager-settings-items-more-button'}
                                    {if $item->hasMoreInfo()}
                                        <a class="consent-show-more" href="#" data-collapse="consent-{$id}-description">
                                            ...
                                            <span class="consent-icon">
											<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" role="img" aria-label="{lang key='moreInformation' section='consent'}"><path fill="currentColor" d="M256 8C119.043 8 8 119.083 8 256c0 136.997 111.043 248 248 248s248-111.003 248-248C504 119.083 392.957 8 256 8zm0 110c23.196 0 42 18.804 42 42s-18.804 42-42 42-42-18.804-42-42 18.804-42 42-42zm56 254c0 6.627-5.373 12-12 12h-88c-6.627 0-12-5.373-12-12v-24c0-6.627 5.373-12 12-12h12v-64h-12c-6.627 0-12-5.373-12-12v-24c0-6.627 5.373-12 12-12h64c6.627 0 12 5.373 12 12v100h12c6.627 0 12 5.373 12 12v24z"/></svg>
										</span>
                                        </a>
                                    {/if}
                                {/block}
                            ...
                            <div class="consent-info">
                                {block name='snippets-consent-manager-confirm-info-more-button'}
                                    <a class="consent-show-more" href="#" data-collapse="consent-confirm-info-description">
                                        {lang key='moreInformation' section='consent'}<span class="consent-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" role="img" aria-label="{lang key='moreInformation' section='consent'}"><path fill="currentColor" d="M256 8C119.043 8 8 119.083 8 256c0 136.997 111.043 248 248 248s248-111.003 248-248C504 119.083 392.957 8 256 8zm0 110c23.196 0 42 18.804 42 42s-18.804 42-42 42-42-18.804-42-42 18.804-42 42-42zm56 254c0 6.627-5.373 12-12 12h-88c-6.627 0-12-5.373-12-12v-24c0-6.627 5.373-12 12-12h12v-64h-12c-6.627 0-12-5.373-12-12v-24c0-6.627 5.373-12 12-12h64c6.627 0 12 5.373 12 12v100h12c6.627 0 12 5.373 12 12v24z"/></svg></span>
                                    </a>
                                {/block}
