                        ...
                        <ul class="list-unstyled">
                            ...
                            {block name='basket-cart-dropdown-cart-item-favourable-shipping'}
                                {if $favourableShippingString !== ''}
                                    <li class="cart-dropdown-total-item">Zzgl. <a style="text-decoration: underline" href="https://www.dichtstoffe-shop.de/Dichtstoffe-Shop-Versandkosten" class="shipment popup">Versandkosten</a></li>
                                {/if}
                            {/block}
                        </ul>
                    {/block}
