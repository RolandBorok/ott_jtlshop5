                            ...
                            <div class="basket_wrapper">
                                {block name='basket-index-basket-items'}
                                    ...
                                    {/block}
                                                        ...
                                                        <div style="color:#000;padding:5px;border:1px solid #ff0000;font-size:12px;margin:15px 0 0;font-size:14px;">Der hier angezeigte Preis ist einschließlich deutscher Umsatzsteuer. Bitte beachten Sie, dass der Endpreis von der tatsächlichen Umsatzsteuer abhängig ist, die für Ihre Bestellung anfällt.  Wenn Sie als Privatkunde (B2C) aus dem EU-Ausland bestellen, wird aufgrund der Umsatzsteuerreform ab 01. Juli 2021 die gültige Umsatzsteuer für das Bestimmungsland berechnet. Der Endpreis wird in der Bestellübersicht vor Abschluss der Bestellung ersichtlich, sobald Sie Ihre persönlichen Daten und das Bestimmungsland eingegeben haben.</div>
                        
    <ul class="vorteile"><li>24-Stunden Dichtstoffautomat.</li><li>Bei uns erhalten Sie nur Produkte namhafter Hersteller.</li>
      <li>Wir bieten Ihnen nur Ware an, die wir auch selber als Fachbetrieb einsetzen.</li>
      <li>Telefonische Beratung unter
    (0 73 71) 96 59 780 (zum Ortstarif).</li>
      <li>Mixpac ™, COX™ und MK™ Brands of Medmix Verarbeitungsgeräte für Dicht- und Klebstoffe</li>
    </ul>
