{block name='layout-header'}
    ...
    {block name='layout-header-body-tag'}
        <body class="{if $Einstellungen.template.theme.button_animated === 'Y'}btn-animated{/if}
                     ...
                     {if $nSeitenTyp === $smarty.const.PAGE_WARENKORB} is-warenkorb{/if} is-nova"
    ...
    {if !$bExclusive}
        ...
        {block name='layout-header-header'}
            ...
            <div id="topbar"><div class="container-fluid container-fluid-xl">
                <ul class="vkf"> <li class="rechner links"><a href="https://www.dichtstoffe-shop.de/Verbrauchsrechner-Bedarfsermittler">Verbrauchsrechner<br /><span>f&uuml;r Dichtmassen und Klebstoffe</span></a></li>
 <li class="versandkostenfrei links">Pakete ab 75 &euro; Bestellwert innerhalb<br />deutschlands versandkostenfrei</li>
</ul>
